...
export default function ContactSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Send to Formspree endpoint (free service that forwards form submissions to email)
      const response = await fetch('https://formspree.io/f/meoljnwr', {
        method: 'POST',
        headers: {
      ...
      alert('Failed to send message. Please try again or contact me directly at mohamedamineezzaouia3@gmail.com')
    } finally {
          ...
          >
            <div className="glass p-6 flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400">mohamedamineezzaouia3@gmail.com</p>
              </div>
            </div>
            ...
            <div className="glass p-6 flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400">+216 55 999 889</p>
              </div>
            </div>
