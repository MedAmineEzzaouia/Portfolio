...
const stats = [
  {
    ...
    description: "Completed FinTech, AI, and game development projects including VaR systems and trading simulators",
  ...
  },
  {
    ...
    description: "Through IEEE leadership, Rotaract projects, and professional work",
  ...
  },
  {
    ...
    value: "16.5",
    label: "GPA Score",
    description: "Academic excellence in Computer Engineering with INFINI specialization",
  ...
  },
  {
    ...
    description: "Professional certifications in Docker, Kubernetes, AI, and modern frameworks",
    ...
    if (isInView) {
      ...
      stats.forEach((stat, index) => {
        ...
        const finalValue = isDecimal 
          ? Number.parseFloat(stat.value.replace(/[^\d.]/g, ""))
        ...
        const timer = setInterval(() => {
          ...
          setCounters((prev) => {
            ...
            newCounters[index] = isDecimal ? Number.parseFloat(current.toFixed(1)) : Math.floor(current)
            return newCounters
          })
        }, 16) // ~60fps
      })
