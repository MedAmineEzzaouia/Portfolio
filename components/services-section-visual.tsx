...
const services = [
  {
    ...
    clickable: true,
    chatMessage:
      "I'm interested in technology solutions and services. Can you tell me about your technical expertise and solutions?",
  },
  {
    icon: Workflow,
  ...
  },
  {
    ...
    clickable: true,
    chatMessage:
      "I'm interested in consultation services. Can you tell me more about your professional consultation solutions?",
  },
  {
    icon: Code,
...
export default function ServicesSection() {
  ...
  const handleServiceClick = (service: any) => {
    if (service.clickable) {
      // Scroll to Professional chat section
