          ...
          <div className="space-y-6">
            ...
            >
              ...
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-heading font-bold overflow-hidden">
                <AnimatedText text="Mohamed" className="inline-block" delay={500} />
                <br />
                <AnimatedText text="Amine" className="inline-block" delay={800} />
              </h1>
              ...
              >
                Computer Engineering graduate specializing in Financial Technology. Passionate about integrating AI, data analysis, and risk management to develop innovative financial solutions.
              </motion.p>
