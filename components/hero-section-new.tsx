      ...
      <motion.div style={{ opacity, scale, y }} className="container mx-auto px-4 lg:pl-20 relative z-10">
        ...
        <div className="lg:hidden flex flex-col items-center text-center space-y-4 pt-16">
          ...
          >
            ...
            <span className="text-primary font-medium text-xs">👋 Hi, I'm Mohamed Amine Ezzaouia</span>
          </motion.div>
          ...
          >
            ...
            <span className="block text-gradient">FINTECH</span>
            <span className="block italic text-secondary">ENGINEER</span>
          </motion.h1>
          ...
          >
            Crafting innovative FinTech solutions and AI-driven financial systems.
          ...
          >
            <div className="relative glass rounded-xl p-4 border border-white/10 max-w-xs">
              ...
              <div className="text-center">
                ...
                <p className="text-primary font-medium text-xs mb-2">FinTech Engineer</p>
          ...
          <div className="space-y-8">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-primary font-medium">👋 Hi, I'm Mohamed Amine Ezzaouia</span>
              </div>
            ...
            >
              ...
              <div className="relative glass rounded-3xl p-8 border border-white/10 overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <div className="text-center">
                    <h3 className="text-2xl font-bold mb-2">Mohamed Amine Ezzaouia</h3>
                    <p className="text-primary font-medium mb-4">Fintech Engineer</p>
