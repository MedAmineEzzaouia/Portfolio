...
import { Home, User, Code, Briefcase, MessageCircle, Menu, X, BookOpen, Laptop } from "lucide-react"
import Link from "next/link"

const navItems = [
  { name: "About", href: "#about", icon: User },
  { name: "Skills", href: "#skills", icon: Code },
  { name: "Work", href: "#experience", icon: Laptop },
              ...
              <div className="container mx-auto px-6 py-4">
                <div className="flex justify-between items-center">
                  <Link href="#home" className="text-2xl font-heading font-bold">
                    <span className="text-gradient">Mohamed Amine Ezzaouia</span>
                  </Link>
